...
from gp.GPopulation import GPopulation
from gp.GenomeBase import GenomeBase
...
class GSimpleGA:
    ...
    # by Liang Yifan
    # collect functions of operators
    def gp_collect_functions(self):
        prefix = self.getParam("gp_function_prefix")
        import Main as mod_main
                    ...
                    if sys_platform[:3] == "win":
                        if msvcrt.kbhit():
                            if ord(msvcrt.getch()) == Consts.CDefESCKey:
                                ...
                                from pyevolve.gp import Interaction
                                print " done !"
