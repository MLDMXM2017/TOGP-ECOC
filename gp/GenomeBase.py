...
import gp.Util
from gp.FunctionSlot import FunctionSlot
...
class GenomeBase:
    ...
    def __repr__(self):
        ...
        allSlots = self.allSlots = [self.evaluator, self.initializator, self.mutator, self.crossover]
    ...
    def addChild(self, child):
        ...
        if type(child) == list:
            ...
            if not isinstance(child, GTreeNodeBase):
                pyevolve.gp.Util.raiseException("The child must be a node", TypeError)
...
class GTreeBase:
    ...
    def __init__(self, root_node):
        ...
        # selfdefined variables by Hanrui
    ...
    def setRoot(self, root):
        ...
        if not isinstance(root, GTreeNodeBase):
            pyevolve.gp.Util.raiseException("The root must be a node", TypeError)
        self.root_node = root
    ...
    def traversal(self, callback, start_node=None):
        ...
        if not inspect.isfunction(callback):
            pyevolve.gp.Util.raiseException("The callback for the tree traversal must be a function", TypeError)
    ...
    def convertTree(self):
        import pyevolve.ecoc.TreeMatrixConvertor  as tmc
